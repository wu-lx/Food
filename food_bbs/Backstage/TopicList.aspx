<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopicList.aspx.cs" Inherits="food_bbs.Backstage.TopicList" %>
    ...
    <div id="content">
	 <div id="content-header">
		...
		<div id="separate">
            ...
            &nbsp;&nbsp;&nbsp;
            <a href="TopicList.aspx" title="标签板块" class="tag">帖子管理</a>
		</div>

        <div id="choosetopic">
            
            <asp:button ID="allDel" text="批量删除" runat="server" />
            &nbsp;&nbsp;&nbsp;帖子名称:
            <asp:TextBox   runat="server" Height="25px" Width="160px" Text="请输入帖子名称..."></asp:TextBox>
            &nbsp;&nbsp;所属标签:
            <asp:DropDownList ID="tag"  runat="server"  autopostback="true" Height="28px" Width="160px" ></asp:DropDownList>
            &nbsp;&nbsp;发表用户:
            <asp:TextBox  runat="server" Height="25px" Width="160px"></asp:TextBox>
            &nbsp;
            <asp:button ID="enquiry" text="查询" runat="server"  />
        </div>
        <div id="topicAdm">
            <span>帖子列表</span>
            <div>
